...
public class Cache extends LinkedHashMap {
    ...
    public Object put(Object key, Object value) {
        ...
        for (Iterator i = values().iterator(); i.hasNext();) {
            ...
            if (ce.image != null) {
                total += ce.image.getWidth() * ce.image.getHeight() * 5;
            }
        }
        return old;
    }
    ...
    public void clear() {
        ...
        try {
            ...
            // ava.lang.OutOfMemoryError: unable to create new native thread in
            // java.lang.System.runFinalization(Unknown Source)
        }
        Util.sleep(1000);
        for (Iterator i = values().iterator(); i.hasNext();) {
            CacheEntry ce = (CacheEntry)i.next();
