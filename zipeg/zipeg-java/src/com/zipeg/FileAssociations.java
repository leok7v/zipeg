...
public class FileAssociations extends JPanel {
    ...
    public void create(long selected, boolean apply) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            String label = FileAssociationHandler.ext2uti[i][1];
            String text =
                    "<html><body>" +
    ...
    public Dimension getPreferredSize() {
        return new Dimension(buttons == null ? 430 : Math.max(430, buttons.getPreferredSize().width), 360);
    }
