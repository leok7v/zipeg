...
+ (NSDate*)dateWithTicksSince1601:(long long)ticks {
    ticks -= MICROSOFT_TICKS_FROM_1601_TO_1970;
    NSTimeInterval timeInterval = ticks / (constIntMicrosecondsPerSecond * 10);
