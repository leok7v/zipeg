...
static inline void ThrowEndOfData()   { throw "end of data"; }
static inline void ThrowUnsupported() { throw "unsupported"; }
static inline void ThrowIncorrect()   { throw "incorrect"; }
static inline void ThrowUnsupportedVersion() { throw "unsupported version"; }
    ...
    )
{
  ...
  catch(const char*) { return S_FALSE; }
}
