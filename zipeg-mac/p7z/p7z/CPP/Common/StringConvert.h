...
UString MultiByteToUnicodeString(const AString &srcString, int codePage = CP_ACP);
AString UnicodeStringToMultiByte(const UString &srcString, int codePage, char defaultChar, bool &defaultCharWasUsed);
AString UnicodeStringToMultiByte(const UString &srcString, int codePage = CP_ACP);
...
inline UString GetUnicodeString(const AString &multiByteString, int codePage)
...
inline AString GetOemString(const UString &unicodeString)
  ...
  inline const UString& GetSystemString(const UString &unicodeString)
    { return unicodeString;}
  inline const wchar_t* GetSystemString(const wchar_t* unicodeString, int /* codePage */)
    { return unicodeString;}
  inline const UString& GetSystemString(const UString &unicodeString, int /* codePage */)
    { return unicodeString;}
  inline UString GetSystemString(const AString &multiByteString, int codePage)
    { return MultiByteToUnicodeString(multiByteString, codePage);}
  ...
  inline AString GetSystemString(const UString &unicodeString)
    { return UnicodeStringToMultiByte(unicodeString); }
  inline AString GetSystemString(const UString &unicodeString, int codePage)
