/*
 * @(#)parse_manifest.c	1.23 06/03/21
 *
 ...
 * the END record signature.  (Who designed this mess!)
 *
 * (zip files were clearly designed to make writing a zip file easier
 * than reading one. Now isn't that precious...)
 *
 *	fd:	File descriptor of the jar file.
