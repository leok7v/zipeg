...
*/
    ...
    private void hidePopup() {
        ...
        if (mf != null) {
            sp.setVisible(false);
            JComponent gp = (JComponent)mf.getGlassPane();
            gp.remove(sp);
            gp.setVisible(false);
            Util.invokeLater(20, new Runnable(){
                public void run() {
    ...
    private void showPopup() {
        ...
        if (popup.getModel().getSize() == 0 || MainFrame.getInstance() == null) {
            return;
        }
        ...
        h = ((h + cell.height - 1) / cell.height) * cell.height + insets.top + insets.bottom;
        sp.setSize(new Dimension(getWidth() + 4, h + 16));
